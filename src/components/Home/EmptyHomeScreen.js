...
function EmptyHomeScreen() {
  return (
    <div className="row">
      <div className="col-sm dist-cxu-box">
      ...
      <div className="col-sm dist-uxpae-box">
        <div className="bg-light empty-container-2 mb-3 d-flex justify-content-center align-items-center">
